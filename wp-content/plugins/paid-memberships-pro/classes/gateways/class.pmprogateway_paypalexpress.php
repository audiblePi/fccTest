	...
	class PMProGateway_paypalexpress extends PMProGateway
	{
		...
		function setExpressCheckout(&$order)
		{
			...
			if("SUCCESS" == strtoupper($this->httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($this->httpParsedResponseAr["ACK"])) {
				...
				//$paypal_url = "https://www.paypal.com/checkoutnow?useraction=commit&token=" . $this->httpParsedResponseAr['TOKEN'];
				...
				if("sandbox" === $environment || "beta-sandbox" === $environment)
				{
					...
					//$paypal_url = "https://www.paypal.com/checkoutnow?useraction=commit&cmd=_express-checkout&token="  . $this->httpParsedResponseAr['TOKEN'];
				}
