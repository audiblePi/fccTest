(function() {
  ...
  Morris.Grid = (function(_super) {
    ...
    Grid.prototype.drawGoal = function(goal, color) {
      return this.raphael.path("M" + this.left + "," + (this.transY(goal)) + "H" + this.right).attr('stroke', color).attr('stroke-width', this.options.goalStrokeWidth).attr('stroke-dasharray', this.options.gridDashed);
    };
